...
class ContactController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('contacts.create', compact('menus'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('contacts.index')->with('success', 'Contact berhasil dibuat.');
    }
    ...
    public function edit($id)
    {
        ...
        $menus = Menu::orderBy('name')->get();
        return view('contacts.edit', compact('contact', 'menus'));
    }
