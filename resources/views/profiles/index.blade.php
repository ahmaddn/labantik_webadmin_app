                                        ...
                                        <div id="editProfileModal{{ $p->id }}" modal-center=""
                                            ...
                                            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                                                ...
                                                <div
                                                    ...
                                                    <form id="edit-form" action="{{ route('profiles.update', $p->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                    ...
                                                    <div class="mt-5 text-center">
                                                        ...
                                                        <div class="flex justify-center gap-2 mt-6">
                                                            <form class="delete-form"
                                                                action="{{ route('profiles.destroy', $p->id) }}"
                                                                method="post">
                                                                @method('DELETE')
                                                                @csrf
                                                                <button type="reset"
                ...
                <div id="addProfileModal" modal-center=""
                    ...
                    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                        ...
                        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                            <form class="create-form" id="create-form" action="{{ route('profiles.store') }}"
                                method="POST">
                                @csrf
                                <div class="xl:col-span-6">
