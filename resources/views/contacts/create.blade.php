...
<div
    ...
    <div class="container mx-auto p-6">
        <div class="max-w-4xl mx-auto bg-white rounded shadow-sm p-6">
            <h2 class="text-2xl font-semibold mb-6">Tambah Kontak</h2>
            @if ($errors->any())
            ...
            <form action="{{ route('contacts.store') }}" method="POST">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 md:col-span-6">
                        ...
                        <input type="text" name="address_1" class="block w-full rounded border-gray-200 shadow-sm p-3"
                            required>
                    </div>

                    <div class="col-span-12 md:col-span-6">
                        <label class="block text-sm font-medium mb-2">Address 2 (opsional)</label>
                        <input type="text" name="address_2" class="block w-full rounded border-gray-200 shadow-sm p-3">
                    </div>

                    <div class="col-span-12 md:col-span-6">
                        <label class="block text-sm font-medium mb-2">Email</label>
                        <input type="email" name="email" class="block w-full rounded border-gray-200 shadow-sm p-3">
                    </div>

                    <div class="col-span-12 md:col-span-6">
                        <label class="block text-sm font-medium mb-2">No Telp</label>
                        <input type="text" name="no_telp" class="block w-full rounded border-gray-200 shadow-sm p-3">
                    </div>
                    ...
                    <div class="col-span-12 text-right mt-4">
                        ...
                        <a href="{{ route('contacts.index') }}" class="inline-block px-4 py-2 ml-2 border rounded">Batal</a>
                    </div>
                </div>
            </form>
        </div>
